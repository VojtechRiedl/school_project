...
class _SongApiService implements SongApiService {
  _SongApiService(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<HttpResponse<SongModel>> getSongById({required int id}) async {
    ...
    final value = SongModel.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
