            ...
            return SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                Text(state.songEntity.title, style: const TextStyle(fontSize: 24, color: Palette.darkTextColor, fontWeight: FontWeight.bold)),
                Text(state.songEntity.poster, style: const TextStyle(fontSize: 16, color: Palette.darkTextColor, fontWeight: FontWeight.bold)),
                ...
                VideoPlayer(url: "${Environment.apiUrl}/songs/video/${state.songEntity.id}") : const SizedBox(height: 200, child: Center(child: Text("Video nenalezeno")),),
                ...
                MusicPlayer(url:"${Environment.apiUrl}/songs/sound/${state.songEntity.id}" ) : const SizedBox(height: 150, child: Center(child: Text("Písnička nenalezena")),),
